...
##                0.8*act_tmp,0.5*anti_act_tmp_p1,0.5*act_tmp_p1,0.5*anti_act_tmp,0.5*act_tmp])
    r=np.array([0.4,0.4,0.8*y[0],0.8*y[1],1.0*act_tmp_p1,1.0*anti_act_tmp_p1,0.8*y[1],\
                0.8*y[0],0.5*anti_act_tmp_p1,0.5*act_tmp_p1,0.5*y[1],0.5*y[0]])
